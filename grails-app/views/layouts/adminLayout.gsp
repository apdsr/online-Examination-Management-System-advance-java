            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue dropdown-modal">
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li>
                            <a href="${createLink(controller: 'authenticate',action:'adminLogout')}" target="_self">
    ...
    <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
        ...
        <ul class="nav nav-list">
            <li class="active open">
                ...
                <ul class="submenu">
                    <li class="">
                        <a href="${createLink(controller: 'menuLink',action: 'adminpage',params: ['view':'userCreation'])}" class="nav-link ">
                    ...
                    <li class="">
                        <a href="${createLink(controller: 'menuLink',action: 'adminadexam',params: ['view':'adexam'])}" class="nav-link ">
                            <i class="menu-icon fa fa-caret-right"></i>
                            Add Examination
                        </a>
                    ...
                    <li class="">
                        <a href="${createLink(controller: 'menuLink',action: 'adminquestion',params: ['view':'addquestion'])}" class="nav-link ">
                            <i class="menu-icon fa fa-caret-right"></i>
                            Add Question
                        </a>
                    ...
                    %{--<li class="">--}%
                        %{--<a href="${createLink(controller: 'menuLink',action: 'adminpage',params: ['view':'optionMaster'])}" class="nav-link ">--}%
                            %{--<i class="menu-icon fa fa-caret-right"></i>--}%
                            %{--Contact Us--}%
                        %{--</a>--}%
                    ...
                    %{--</li>--}%
                    %{--<li class="">--}%
                        %{--<a href="${createLink(controller: 'menuLink',action: 'adminpage',params: ['view':'optionGroup'])}" class="nav-link ">--}%
                            %{--<i class="menu-icon fa fa-caret-right"></i>--}%
                            %{--About Us--}%
                        %{--</a>--}%
        ...
        <div class="footer-inner">
            <div class="footer-content">
                <span class="bigger-120">
                    %{--<span class="blue bolder">&copy; 2018-2019 Feedback</span>--}%
                    %{--Powered By <a href="www.bestsolutions.co.in" >Best Solutions</a>--}%
                %{--</span>--}%
